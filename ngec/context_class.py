...
def _load_model(model_dir):
    """
    Load the context classification models. 
...
class EventClass:
    ...
    def process(self, story_list):
        """
        Process a list of stories to detect the document context.
        ...
        -------
        story_list: list of dicts
          Each story dictionary now contains an "contexts" key with a list of detected contexts (str). E.g.: 
          'contexts': ['diplomatic', 'legal']
